  ...
  $conexion->query(" insert into envios(pais, direccion,ciudad,coment,id_venta) values
        (   
          '".$_POST['country']."',
          '".$_POST['c_address']."',
          '".$_POST['c_ciudad']."',
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <h2 class="display-3 text-black">Muchas Gracias por su compra!  BICIMEX</h2>
              <p class="lead mb-5">Tu pedido se completo exitosamente.</p>
