              ...
              <table class="table table-bordered" style="background-color:white">
                <thead>
                  <tr>
                    ...
                    <th class="product-remove">Quítalo</th>
                  </tr>
                </thead>
                <tbody>
                <?php  
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row mb-5">
              ...
              <div class="col-md-6">
                <button class="btn btn-outline-primary btn-sm btn-block"><a href="index.php">Continuar Comprando</a></button>
              </div>
            </div>
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Compralo ya! </button>
                  </div>
                </div>
              </div>
            </div>
