    ...
    <header class="position-absolute w-100">
        <div class="container">
            <div class="top-header d-none d-sm-flex justify-content-between align-items-center">
                <div class="contact">
                    <a href="tel:+51983328458" class="tel"><i class="fa fa-phone" aria-hidden="true"></i>+51983328458</a>
                    <a href="bicimex20@gmail.com"><i class="fa fa-envelope"
                            aria-hidden="true"></i>bicimex20@gmail.com</a>
                </div>
                <nav class="d-flex aic">
                   
                    <ul class="nav social d-none d-md-flex">
                        <li><a href="https://www.facebook.com/BiciMex-115535170313271" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.facebook.com/bicimex.tarma.7"><i class="fa fa-google-plus"></i></a></li>
            ...
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link" href="pagina.php">Nosotros</a></li>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slide-content d-flex align-items-center">
                                <div class="single-slide">
                                    ...
                                    <p data-aos="fade-right" data-aos-delay="600"> Bicicletas super económicas , mejor  calidad-precio  detodo el mercado nacional <br>con garantía 100%
                                    </p>
                                    <a data-aos="fade-right" data-aos-delay="900" href="index.php" class="btn btn-primary">Verlas ahora</a>
                            ...
                            <div class="swiper-slide slide-content d-flex align-items-center">
                                <div class="single-slide">
                                    ...
                                    <p data-aos="fade-right" data-aos-delay="600">Repuestos de marcas reconocidas <br> mejor calidad-precio de todo el mercado ,con una  gran variedad .
                                    </p>
                                    <a data-aos="fade-right" data-aos-delay="900" href="index.php" class="btn btn-primary">Verlas ahora</a>
        ...
        <div class="container">
            <div class="row">
                <div class="offset-xl-1 col-xl-6" data-aos="fade-right" data-aos-delay="200" data-aos-duration="800">
                    ...
                    <p>Somos una empresa dedicada a la comercialización de Bicicletas y sus accesorios de alta calidad y 100% recomendados.
                    </p>
            ...
            <div class="row no-gutters">
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="0"
                        ...
                        <a href="http://localhost/tienda/shop-single.php?id=1" class="btn btn-primary">Solicítalo</a>
                ...
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="300"
                        ...
                        <a href="http://localhost/tienda/shop-single.php?id=2" class="btn btn-primary">Solicítalo</a>
                        <svg viewBox="0 0 170 193">
                            <path fill-rule="evenodd" fill="rgb(238, 21, 21)"
                                d="M39.000,31.999 C39.000,31.999 -21.000,86.500 9.000,121.999 C39.000,157.500 91.000,128.500 104.000,160.999 C117.000,193.500 141.000,201.000 150.000,183.000 C159.000,165.000 172.000,99.000 167.000,87.000 C162.000,75.000 170.000,63.000 152.000,45.000 C134.000,27.000 128.000,15.999 116.000,11.000 C104.000,6.000 89.000,-0.001 89.000,-0.001 L39.000,31.999 Z" />
                        </svg>
                ...
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="600"
                        ...
                        <p>100% Calidad</p>
                        <p>Stock Limitado</p>
                        <a href="http://localhost/tienda/shop-single.php?id=21" class="btn btn-primary">Solicítalo</a>
                        <svg viewBox="0 0 170 193">
                            <path fill-rule="evenodd" fill="rgb(238, 21, 21)"
                                d="M39.000,31.999 C39.000,31.999 -21.000,86.500 9.000,121.999 C39.000,157.500 91.000,128.500 104.000,160.999 C117.000,193.500 141.000,201.000 150.000,183.000 C159.000,165.000 172.000,99.000 167.000,87.000 C162.000,75.000 170.000,63.000 152.000,45.000 C134.000,27.000 128.000,15.999 116.000,11.000 C104.000,6.000 89.000,-0.001 89.000,-0.001 L39.000,31.999 Z" />
                        </svg>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="row">
                                <div class="offset-lg-1 col-lg-10">
                                    ...
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600"
                                        data-aos-offset="0">SAMUEL Medrano</h5>
                        ...
                        <div class="swiper-slide text-center">
                            <div class="row">
                                <div class="offset-lg-1 col-lg-10">
                                    ...
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600"
                                        data-aos-offset="0">HEIMI MAYTA</h5>
                                    <span data-aos="fade-up" data-aos-delay="400" data-aos-duration="600"
                                        data-aos-offset="0">ADMINISTRADORA</span>
                        ...
                        <div class="swiper-slide text-center">
                            <div class="row">
                                <div class="offset-lg-1 col-lg-10">
                                    <div class="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0"><img
                                            src="assets/images/sarita.png" alt="Testimonial 1"></div>
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600"
                                        data-aos-offset="0">ZARAÍ MEDRANO</h5>
                                    <span data-aos="fade-up" data-aos-delay="400" data-aos-duration="600"
                                        data-aos-offset="0">MARKETING
                                        Designer</span>
            ...
            <div class="container">
                <div
                    ...
                    <p class="mb-0" data-aos="fade-left" data-aos-offset="0">
                        <a href="https://www.facebook.com/samuelito.medranoquispe/">Design by: Samuel Medrano</a></p>
                </div>
            </div>
        </div>
