...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="./admin/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<body class="hold-transition login-page" style="background-color:#f75b6d ">
<div class="login-box">
  <div class="login-logo">
    <a href="./index.php" style="Color:WHITE ; font-size:40px"><b>Clientes BICIMEX</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
        <a href="index.php">Registrate comprando en Bicimex</a>
      </p>
